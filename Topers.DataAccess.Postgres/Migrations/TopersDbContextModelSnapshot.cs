...
namespace Topers.DataAccess.Postgres.Migrations
{
    ...
    partial class TopersDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Topers.DataAccess.Postgres.Entities.CartEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Topers.DataAccess.Postgres.Entities.CartItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Topers.DataAccess.Postgres.Entities.CartEntity", b =>
                {
                    b.HasOne("Topers.DataAccess.Postgres.Entities.CustomerEntity", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("Topers.DataAccess.Postgres.Entities.CartEntity", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Topers.DataAccess.Postgres.Entities.CartItemEntity", b =>
                {
                    b.HasOne("Topers.DataAccess.Postgres.Entities.CartEntity", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Topers.DataAccess.Postgres.Entities.GoodScopeEntity", "Good")
